...
9. **See the Dataflow job running**: As soon as you upload the files in GCS bucket, the Dags will be initiated. You will be able to see the Dataflow job running in the Dataflow tab. 
